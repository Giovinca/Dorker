...
#*##*##*##*##*##*##*##*##*##*##*##*##*# 
#*#                  			    #*#               
#*#  Coded by Mr.V1nch404  #*#
#*#      							#*#
#*#     mail : giovincaid@outlook.com		#*#
#*#  			 or 				#*#
#*#        Giovinca ID	    	#*#
#*#									#*#
#*#      	MaDe In Indonesia			#*#
...
echo $yellow.$bold."                          | Author ".$green."|".$blue." Mr.V1nch404        ".$yellow."  |                "."\n";
echo $yellow.$bold."                          | From   ".$green."|".$white." Indonesia           ".$yellow."|                "."\n";
echo $yellow.$bold."                          | Team   ".$green."|".$green." Maxteroit ".$yellow."|                "."\n";
echo $yellow.$bold."                         -============================-                "."\n";
echo $yellow.$bold."\n       		              STARTING  "; 
